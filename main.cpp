...
#define FEATURE_QUATERNION              0x0001
#define FEATURE_EULER                   0x0002
#define FEATURE_YAWPITCHROLL            0x0004
#define FEATURE_ACCEL                   0x0008
#define FEATURE_REALACCEL               0x0010
#define FEATURE_WORLDACCEL              0x0020
#define FEATURE_GRAVITY                 0x0040
#define FEATURE_TEAPOT                  0x0080
...
uint16_t  features=FEATURE_NONE;
...
void loop() {
    ...
    // otherwise, check for DMP data ready interrupt (this should happen frequently)
        ...
        if(features & FEATURE_WORLDACCEL){
